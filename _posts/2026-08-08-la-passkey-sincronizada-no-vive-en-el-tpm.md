...
<svg viewBox="0 0 900 450" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Diagrama: la clave de identidad del dispositivo está sellada en el TPM, mientras que el blob envuelto, la base de datos de sincronización con las claves de passkey y el Security Domain Secret en memoria quedan dentro del alcance de un proceso sin privilegios">
  ...
  <rect x="88" y="38" width="380" height="72" fill="none" stroke="#6B5D40" stroke-width="1.5"/>
  <text x="106" y="70" font-family="'Inter', sans-serif" font-size="13" font-weight="600" fill="#0A0A0A">Clave de identidad de dispositivo</text>
  <text x="106" y="92" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">GENERADA Y SELLADA POR EL HARDWARE</text>
  <text x="488" y="76" font-family="'Inter', sans-serif" font-size="12" fill="#5C6166">La única pieza que el hardware protege de verdad.</text>

  <line x1="278" y1="110" x2="278" y2="170" stroke="#B9BEC2" stroke-width="1"/>
  <path d="M274,168 L278,176 L282,168 Z" fill="#9AA0A6"/>
  <text x="292" y="134" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">CHROME LA GUARDA ENVUELTA</text>

  <rect x="76" y="140" width="794" height="250" fill="none" stroke="#DADCDE" stroke-width="1" stroke-dasharray="3 4"/>
  <text x="856" y="160" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6B5D40" text-anchor="end">ALCANCE DEL MALWARE SIN PRIVILEGIOS</text>

  <g font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">
    <text x="88" y="164">EN DISCO</text>
  </g>
  <rect x="88" y="176" width="370" height="88" fill="none" stroke="#DADCDE" stroke-width="1"/>
  <text x="106" y="206" font-family="'JetBrains Mono', monospace" font-size="13" fill="#0A0A0A">passkey_enclave_state</text>
  <text x="106" y="228" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">BLOB DE LA CLAVE DE IDENTIDAD</text>
  <text x="106" y="248" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">SE IMPORTA Y EL TPM FIRMA A PETICIÓN</text>

  <rect x="486" y="176" width="370" height="88" fill="none" stroke="#DADCDE" stroke-width="1"/>
  <text x="504" y="206" font-family="'JetBrains Mono', monospace" font-size="13" fill="#0A0A0A">Sync Data\LevelDB</text>
  <text x="504" y="228" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">WebauthnCredentialSpecifics</text>
  <text x="504" y="248" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">CLAVES CIFRADAS · SERVICIOS EN CLARO</text>

  <g font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">
    <text x="88" y="296">EN MEMORIA DEL PROCESO DE CHROME</text>
  </g>
  <rect x="88" y="308" width="470" height="64" fill="none" stroke="#DADCDE" stroke-width="1"/>
  <text x="106" y="338" font-family="'Inter', sans-serif" font-size="13" font-weight="600" fill="#0A0A0A">Security Domain Secret · 32 bytes</text>
  <text x="106" y="358" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">DESCIFRA TODAS LAS PASSKEYS DE LA CUENTA</text>
  <text x="580" y="334" font-family="'Inter', sans-serif" font-size="12" fill="#5C6166">En claro durante los flujos</text>
  <text x="580" y="352" font-family="'Inter', sans-serif" font-size="12" fill="#5C6166">de recuperación.</text>

  <text x="88" y="416" font-family="'Inter', sans-serif" font-size="12" fill="#5C6166">El TPM impide copiar la clave de identidad. No impide que otro proceso la use.</text>
  <text x="88" y="442" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">DÓNDE VIVE CADA CLAVE EN UNA PASSKEY SINCRONIZADA · CHROME SOBRE WINDOWS</text>
</svg>
...
<svg viewBox="0 0 900 356" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Matriz de cobertura: Pass-ta-key deja lectura de ficheros y necesita Event ID 4663 con auditoría y SACL; Silver deja el borrado del enclave y necesita Sysmon 23 o 26 con la ruta incluida en la configuración; Golden deja lectura de memoria de Chrome y lo cubre Sysmon 10 de serie">
  ...
  <line x1="84" y1="58" x2="870" y2="58" stroke="#B9BEC2" stroke-width="1"/>

  <text x="88" y="92" font-family="'Inter', sans-serif" font-size="13" font-weight="600" fill="#0A0A0A">Pass-ta-key</text>
  <text x="88" y="110" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6B5D40">REGLA 1</text>
  <text x="290" y="92" font-family="'JetBrains Mono', monospace" font-size="11" fill="#5C6166">Lectura del enclave y la LevelDB</text>
  <text x="540" y="92" font-family="'JetBrains Mono', monospace" font-size="11" fill="#5C6166">Security 4663</text>
  <circle cx="696" cy="88" r="5" fill="none" stroke="#6B5D40" stroke-width="1.5"/>
  <text x="712" y="92" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">AUDITORÍA + SACL</text>
  <line x1="84" y1="128" x2="870" y2="128" stroke="#EBEEF1" stroke-width="1"/>

  <text x="88" y="162" font-family="'Inter', sans-serif" font-size="13" font-weight="600" fill="#0A0A0A">Silver Pass-ta-key</text>
  <text x="88" y="180" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6B5D40">REGLA 2</text>
  <text x="290" y="162" font-family="'JetBrains Mono', monospace" font-size="11" fill="#5C6166">Borrado del estado del enclave</text>
  <text x="540" y="162" font-family="'JetBrains Mono', monospace" font-size="11" fill="#5C6166">Sysmon 23/26</text>
  <circle cx="696" cy="158" r="5" fill="none" stroke="#6B5D40" stroke-width="1.5"/>
  <text x="712" y="162" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">RUTA EN LA CONFIG</text>
  <line x1="84" y1="198" x2="870" y2="198" stroke="#EBEEF1" stroke-width="1"/>

  <text x="88" y="232" font-family="'Inter', sans-serif" font-size="13" font-weight="600" fill="#0A0A0A">Golden Pass-ta-key</text>
  <text x="88" y="250" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6B5D40">REGLA 3</text>
  <text x="290" y="232" font-family="'JetBrains Mono', monospace" font-size="11" fill="#5C6166">Lectura de memoria de chrome.exe</text>
  <text x="540" y="232" font-family="'JetBrains Mono', monospace" font-size="11" fill="#5C6166">Sysmon 10</text>
  <circle cx="696" cy="228" r="5" fill="#6B5D40"/>
  <text x="712" y="232" font-family="'JetBrains Mono', monospace" font-size="10" fill="#0A0A0A">DE SERIE</text>
  <line x1="84" y1="268" x2="870" y2="268" stroke="#B9BEC2" stroke-width="1"/>

  <circle cx="92" cy="298" r="5" fill="none" stroke="#6B5D40" stroke-width="1.5"/>
  <text x="108" y="302" font-family="'Inter', sans-serif" font-size="12" fill="#5C6166">Hay que habilitarlo antes: dos de los tres ataques no dejan rastro con la configuración por defecto.</text>
  <text x="88" y="340" font-family="'JetBrains Mono', monospace" font-size="10" fill="#6F7376">COBERTURA DE DETECCIÓN EN EL ENDPOINT · CHROME SOBRE WINDOWS</text>
</svg>
